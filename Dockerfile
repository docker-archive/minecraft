# Minecraft 1.8.1 Dockerfile - Sample
...
MAINTAINER Michael Chiang <mike@kitematic.com>
...
RUN wget -q https://s3.amazonaws.com/Minecraft.Download/versions/1.8.1/minecraft_server.1.8.1.jar
...
CMD echo eula=true > /data/eula.txt && java -jar /minecraft_server.1.8.1.jar
